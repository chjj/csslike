...
var parse = (function() {
  ...
  var nested_at = function() {
    ...
    if (token_.name === '@trait') { 
      trait(token_, traits, body);
      return '';
    }
...
var trait = function(token, traits, body) {
